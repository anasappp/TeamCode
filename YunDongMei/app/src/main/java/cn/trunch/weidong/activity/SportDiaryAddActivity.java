    ...
    public void initListener() {
        ...
        programAddReleaseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                diaryEntity.setDiaryUid(MyApplication.getInstance().getUserEntity().getObjectId());
                diaryEntity.setDiaryUName(MyApplication.getInstance().getUserEntity().getuNickname());
                diaryEntity.setDiaryType(ApiUtil.DIARY_TYPE);
                diaryEntity.setDiaryContent(programContent);
                diaryEntity.setDiaryContentPreview(HtmlUtil.getText(editor.getHtml()));
                diaryEntity.setDiaryAnonymous(isAnonymous ? 0 : 1);
                diaryEntity.setDiaryImgPreview(programPreview);
                diaryEntity.save(new SaveListener<String>() {
                    @Override
        ...
        bmobFile.uploadblock(new UploadFileListener() {
            ...
            public void done(BmobException e) {
                if(e==null){
                    ...
                    String imgStr = bmobFile.getFileUrl();
                    Log.e(TAG, "done: "+bmobFile.getFileUrl());
                    editor.insertImage(imgStr, "图片");
                    if ("".equals(programPreview))
                        programPreview = imgStr;
                    DialogUIUtils.dismiss(dialog);
