...
public class ApiUtil {
    ...
    //public final static String IP_PORT = "http://www.two2two.xyz/back"; // IP+端口号
        private final static String IP_PORT = "http://192.168.0.114:8080/back"; // IP+端口号
//    private final static String IP_PORT = "http://10.0.2.2:8080/back"; // IP+端口号
    ...
    public final static String USER_SENDSMS = IP_PORT + "/user/sendTestSms";
    ...
    public final static String VIDEO_ALL_LIST = IP_PORT + "/video/getAppAllList";
    public final static String VIDEO_MY_ALL_LIST = IP_PORT + "/video/getAppMyAllList";
    public final static String VIDEO_MY_FOLLOW_ALL_LIST = IP_PORT + "/video/getAppMyFollowAllList";
    public final static String VIDEO_ADD_COLLECTION = IP_PORT + "/video/addCollection";
    public final static String VIDEO_ADD_FOLLOW_INFO = IP_PORT + "/video/addFollowInfo";
