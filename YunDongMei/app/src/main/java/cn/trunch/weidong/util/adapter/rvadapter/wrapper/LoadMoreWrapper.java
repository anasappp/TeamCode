...
public class LoadMoreWrapper<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE_LOAD_MORE) {
            ...
            if (mLoadMoreView != null) {
                mHolder = ViewHolder.createViewHolder(parent.getContext(), mLoadMoreView);
            } else {
                mHolder = ViewHolder.createViewHolder(parent.getContext(), parent, mLoadMoreLayoutId);
            }
            return mHolder;
        }
    ...
    public void onViewAttachedToWindow(RecyclerView.ViewHolder mHolder) {
        ...
        if (isShowLoadMore(mHolder.getLayoutPosition())) {
            setFullSpan(mHolder);
        }
    }

    private void setFullSpan(RecyclerView.ViewHolder mHolder) {
