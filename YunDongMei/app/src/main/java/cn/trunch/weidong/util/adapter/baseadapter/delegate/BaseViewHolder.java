...
import cn.trunch.weidong.util.adapter.CommonOnLongClickListener;
import cn.trunch.weidong.util.adapter.CommonOnTouchListener;
...
public class BaseViewHolder {
    ...
    public BaseViewHolder setLayoutParams(int viewId, ViewGroup.LayoutParams params) {
        getView(viewId).setLayoutParams(params);
        return this;
    }

    public BaseViewHolder setText(int viewId, CharSequence text, @ColorRes int colorRes) {
